...
map.getView().fit([558469.238547, 1488441.426200, 758367.376693, 1662447.465673], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CHITRADURGA RELATIVE RELIEF</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (566 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The relative relief of Chitradurga district exhibits a highly fragmented and varied topography, with values ranging widely from 0.362 to 460.626 metres. The northern and central portions are predominantly characterized by low-relief plains and flat terrain with minimal variations, typically falling under 58.121 metres. Conversely, the western, southern, and eastern margins feature prominent patches of high to very high relative relief exceeding 144.758 metres, indicating localized pockets of rugged, undulating hills and steep ridges intersecting the landscape.';
            }
